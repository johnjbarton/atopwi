...
InspectorBackendStub = function()
{
    ...
    this._registerDelegate('{"method": "Runtime.evaluate", "params": {"expression": {"optional": false, "type": "string"},"objectGroup": {"optional": true , "type": "string"},"includeCommandLineAPI": {"optional": true , "type": "boolean"},"doNotPauseOnExceptions": {"optional": true , "type": "boolean"},"frameId": {"optional": true , "type": "string"},"sendResultByValue": {"optional": true , "type": "boolean"}}, "id": 0}');
    this._registerDelegate('{"method": "Runtime.callFunctionOn", "params": {"objectId": {"optional": false, "type": "string"},"functionDeclaration": {"optional": false, "type": "string"},"arguments": {"optional": true , "type": "object"},"sendResultByValue": {"optional": true , "type": "boolean"}}, "id": 0}');
    ...
    this._registerDelegate('{"method": "Network.getResourceContent", "params": {"identifier": {"optional": false, "type": "string"}}, "id": 0}');
    ...
    this._registerDelegate('{"method": "Debugger.setBreakpointByUrl", "params": {"url": {"optional": false, "type": "string"},"lineNumber": {"optional": false, "type": "number"},"columnNumber": {"optional": true , "type": "number"},"condition": {"optional": true , "type": "string"},"isRegex": {"optional": true , "type": "boolean"}}, "id": 0}');
    ...
    this._eventArgs["Network.requestWillBeSent"] = ["identifier","frameId","loaderId","documentURL","request","timestamp","initiator","stackTrace","redirectResponse"];
    ...
    this._eventArgs["Network.resourceLoadedFromMemoryCache"] = ["identifier","frameId","loaderId","documentURL","timestamp","initiator","resource"];
